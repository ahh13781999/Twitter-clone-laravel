...
let randImg1 = ref("https://loremflickr.com/320/240");
let randImg2 = ref("https://loremflickr.com/320/240");
...
<template>
            ...
            <div class="lg:w-7/12 w-11/12 border-x border-gray-800 relative">
                <div class="bg-black bg-opacity-50 backdrop-blur-md z-10 absolute w-full">
                    <div class="border-gray-800 border-b w-full">
                        ...
                        <div class="flex">
                            <div
                                class="flex items-center justify-center w-full h-[60px] text-white text-[17px] font-extralight p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out">
                                <div class="inline-block text-center border-b-4 border-b-[#1C9CEF] h-[60px]">
                                    <div class="my-auto mt-4">For you</div>
                                </div>
                            </div>
                            <div
                                class="w-full h-[60px] text-gray-500 text-[17px] font-extralight p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out">
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[17px]">Sunak Clock</div>
                                <div class="text-[14px] text-gray-400">98,789 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="#5E5C5C" />
                        </div>
                    </div>
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="text-[14px] text-gray-400">12,229 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="#5E5C5C" />
                        </div>
                    </div>
    ...
    <div v-if="createTweet" id="OverlaySection"
        ...
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
            <div class="flex items-center justify-between md:inline-block p-2 m-2 rounded-full cursor-pointer">
                ...
                <button @click="addTweet()" :disabled="!tweet" :class="tweet ? 'bg-[#1C9CEF] text-white' : 'bg-[#124077] text-gray-400'"
                    class="md:hidden font-extrabold text-[16px] p-1.5 px-4 rounded-full cursor-pointer">Tweet</button>
            </div>
            <div class="w-full flex">
                ...
                <div class="w-[calc(100%-100px)]">
                    ...
                    <div class="w-full">
                        <video v-if="uploadType === 'mp4'" controls :src="showUpload" class="rounded-xl overflow-auto" />
                        <img v-else :src="showUpload" class="rounded-xl min-w-full">
                    </div>
                    <div class="flex py-2 items-center text-[#1C9CEF] font-extrabold">
                        <Earth class="pr-2" fillColor="#1C9CEF" :size="20">Everyone can reply</Earth>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-2">
                        <div class="flex items-center">
                            <div class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                                ...
                                <input @change="getFile" type="file" class="hidden" id="fileUpload">
                            </div>
                            <div class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                        ...
                        <button @click="addTweet()" :disabled="!tweet" :class="tweet ? 'bg-[#1C9CEF] text-white' : 'bg-[#124077] text-gray-400'"
                            class="hidden md:block font-extrabold text-[16px] p-1.5 px-4 rounded-full cursor-pointer">Tweet</button>
                    </div>
                </div>
            </div>
        </div>
